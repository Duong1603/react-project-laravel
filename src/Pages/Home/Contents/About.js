            ...
            <div className="row align-items-center">
              <div className="col-lg-5 py-3 wow fadeInUp">
                ...
                <p className="text-grey mb-4" id="rtt">
                  ...
                  England. It combines the best of hypnotherapy with unique
                  methods for permanent and lasting changes, which result from
                  as little as one session.
                  <br />
                  RTT helps you break ties with bad habits and enables people to
                  achieve extraordinary outcomes in sports, business and
                  performance arts.
                  <br />
                  It also improves focus, motivations and helps overcome fears
                  and phobias.
                </p>
