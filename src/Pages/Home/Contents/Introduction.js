            ...
            <div className="page-section pb-0" id="small-image">
              <div className="container">
                <div className="row align-items-center">
                  <div
                    className="col-lg-2 wow fadeInRight"
                    data-wow-delay="400ms"
                  >
                    <div className="img-place custom-img-1">
                      <img
                        className="small-img"
                        src="../assets/img/img_small.jpeg"
                        alt=""
                      />
                    </div>
                    <br />
                  ...
                  <div className="col-lg-4 py-3 wow fadeInUp">
                    ...
                    <p className="text-grey mb-4" id="custom-phi">
                      ...
                      Phi Phi is a passionate RTT practitioner who loves to
                      accompany you on your healing journey. From as little as
                      one session, Phi Phi is able to help you break free from
                      your undesired habits and problems, such as smoking,
                      gambling, anxiety etc. Through this process, Phi Phi will
                      be your trusted therapist to help you unfold into the
                      version that you’ve always wanted to be.
                    </p>
